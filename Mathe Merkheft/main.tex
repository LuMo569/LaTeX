...
\include{Grundlagen der Differenzialrechnung}
\include{Lineare Gleichungen}
\include{Geraden und Ebenen}
\include{Exponential- und Logarithmusfuktionen}
\include{Integralrechnung}
\include{Funktionen und ihre Graphen}
