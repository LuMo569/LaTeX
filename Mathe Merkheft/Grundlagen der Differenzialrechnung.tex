...
Geometrisch: Tangentensteigung im Punkt $P(x_0|f(x_0))$.
...
kurz: \glqq Ableitung der Gesamtfunktion ist gleich äußere Ableitung mal innere Ableitung.\grqq{}
...
\textit{Beispiel:}\\
Betrachtet werden die Funktion $f$ mit $f(x) = 0,5x^2 + 1$ und der Punkt $P(4 \ | \ 2)$. Bestimme den Punkt $Q$ auf dem Graphen von $f$, der den kleinsten Abstand von $P$ hat. Gib den kleinsten Abstand an.
